...
- [Ignite](https://github.com/kingjethro999/Ignite) — Custom React Native DSL Framework, runs on Expo Go  
  <sub>TypeScript (97.9%), JavaScript (1.4%), CSS (0.7%)</sub>

- [figma-mcp](https://github.com/kingjethro999/figma-mcp) — Figma MCP to boost development speed  
  <sub>JavaScript (97.7%), PLpgSQL (2.3%)</sub>

- [SOC](https://github.com/kingjethro999/SOC)  
  <sub>TypeScript (97%), CSS (2.7%)</sub>

- [BEST](https://github.com/kingjethro999/BEST)  
  <sub>TypeScript (95.5%), CSS (3.4%), JavaScript (1.1%)</sub>

- [bark](https://github.com/kingjethro999/bark)  
  <sub>Jupyter Notebook (56.3%), Python (43.7%)</sub>
...
### 🗣️ Quote
**King Jethro, turning ideas to useful tools**

[![](https://visitcount.itsvg.in/api?id=kingjethro999&icon=2&color=0)](https://visitcount.itsvg.in)
